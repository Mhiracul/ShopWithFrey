    ...
    >
      <div
        className="bg-gradient  justify-center bg-gradient-to-br h-full from-[#131313] to-transparent  
            bg-opacity-20"
      >
        <div className=" container mx-auto flex flex-col h-[90vh] items-left justify-center ">
          <div className="py-2 px-10 rounded-full" data-aos="fade-up">
            <h1 className="uppercase text-shadow-default  text-white text-6xl font-bold">
              frey digitals
            </h1>
            <p
              className="text-sm mt-3 text-[#cfcfcf]"
              data-aos="fade-up"
              data-aos-delay="300"
            >
